    ...
    altair_secondary_sidebar = {
        init: function() {
                if($sidebar_secondary.length) {
                    ...
                    $document.on('click keydown', function (e) {
                        //if ($body.hasClass('sidebar_secondary_persisten')) {
                        //    $body.removeClass('sidebar_secondary_persisten')
                        //    return;
                        //} else {
                        if ($body.hasClass('sidebar_secondary_active') && ((!$(e.target).closest($sidebar_secondary).length) || (e.which == 27)) && $(".swal-overlay--show-modal").length == 0 ) {    //                           
                                altair_secondary_sidebar.hide_sidebar();    //                            
                            }
                        //}
                    });
                    ...
                    // custom scroller
                    altair_helpers.custom_scrollbar($sidebar_secondary.find(".sidebar_scrolleable"));
