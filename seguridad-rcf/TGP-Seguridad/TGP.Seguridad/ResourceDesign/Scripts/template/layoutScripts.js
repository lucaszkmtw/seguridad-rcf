...
//Novedades------
function ObtenerNovedades(_url) {
    $.ajax({
        url: _url,  
        type: 'POST',
        dataType: 'html',
...
function urlApp(_url, _usuario) {
    ...
    hiddenField.setAttribute('name', "usuario");
    hiddenField.setAttribute('value', _usuario);
...
// function ObtenerApps(_url) {
    // $.ajax({
        ...
        // cache: false,
        // beforeSend: function () {
            // $("#appsBtn").prop("disabled", true);
            // //$('#appsBtn').disable();
            // $("#appsBtn1").prop("disabled", true);
            // //$('#appsBtn1').disable();
            // //showLoadingModal()
        // },
        // success: function (html) {
            // $("#appsBtn").prop("disabled", false);
            // $("#appsBtn1").prop("disabled", false);
            // $("#aplicacionesHeader").html(html);
        // },
        // complete: function () {
            // $("#appsBtn").prop("disabled", false);
            // //$('#appsBtn').enable();
...
function ObtenerApps(_url) {
            $.ajax({
                ...
                success: function (html) {
                    $("#cargaApps").css('display', 'none');
                    $("#apps").css('display', 'list-item');
                    $("#apps").css('width', '53px');
                    $("#aplicacionesHeader").html(html);
                },
                complete: function () {
